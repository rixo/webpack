	...
	function hotApply(options) {
		...
		for (i = 0; i < outdatedModules.length; i++) {
			...
			if (
				...
				// Prevent disposed self accepted modules from being required again,
				// which would print a warning and prevent the module from being hot
				// updated because it won't have a chance to accept itself again
				appliedUpdate[moduleId] !== warnUnexpectedRequire
			)
